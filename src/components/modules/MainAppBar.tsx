...
const MainAppBar = ({ navItems, toggleDrawer, handleModalToggle } : {navItems: Array<NavItem>, toggleDrawer: Function, handleModalToggle: Function}) => {
		...
		<AppBar component="nav" position="sticky">
			<Toolbar sx={{ ml: 4, mr: 4 }}>
				...
				<Box sx={{ display: { xs: "none", sm: "block" } }}>
					{navItems.map((item) =>
						item.type === "route" ? (
							<StyledLink to={item.path} key={item.key} sx={{ml:1,mr:1}}>
